...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/student/**").hasAnyRole("ADMIN, STUDENT, TEACHER, COORDINATOR")
                .antMatchers("/class/**").hasAnyRole("ADMIN, TEACHER, COORDINATOR, REPRESENTATIVE")
                .antMatchers("/grade").hasRole("ADMIN")
                .antMatchers("/grade/student/**").hasRole("STUDENT")
                .antMatchers("/grade/class/**", "/grade/teacher/**").hasAnyRole("COORDINATOR, TEACHER")
